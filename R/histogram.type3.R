...
function(x.inf,x.sup,distrib.lab,distrib.check,col.distrib.lab,col.distrib,col.distrib.choose,type.distrib.lab,type.distrib.choose,ep.distrib.lab,ep.distrib.choose) {
  ...
  histogram.distrib(act=TRUE,distrib.lab=distrib.lab,distrib.check=distrib.check,col.distrib.lab=col.distrib.lab,col.distrib=col.distrib,col.distrib.choose=col.distrib.choose,
