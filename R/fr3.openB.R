...
function() {
  ...
  tkgrid(Env$l.fr3$noms.titre.lab,row=5,column=0,sticky="e")
  tkgrid(Env$l.fr3$noms.titre.wdg,row=5,column=1,sticky="w")
  tkgrid(Env$l.fr3$noms.lab1,row=6,column=0,sticky="e")
  tkgrid(Env$l.fr3$noms.list,Env$l.fr3$noms.scroll,row=6,column=1,rowspan=4);tkgrid.configure(Env$l.fr3$noms.scroll,sticky="ens")
  tkgrid(Env$l.fr3$noms.lab2,row=10,column=0,sticky="e")
  tkgrid(Env$l.fr3$noms.wdg,row=10,column=1,sticky="w")
  tkgrid(Env$l.fr3$titre2,row=3,column=3,columnspan=2)
  tkgrid(Env$l.fr3$valeurs.titre.lab,row=5,column=3,sticky="e")
  tkgrid(Env$l.fr3$valeurs.titre.wdg,row=5,column=4,sticky="w")
  tkgrid(Env$l.fr3$valeurs.liminf.lab,row=6,column=3,sticky="e")
  tkgrid(Env$l.fr3$valeurs.liminf.wdg,row=6,column=4,sticky="w")
  tkgrid(Env$l.fr3$valeurs.limsup.lab,row=7,column=3,sticky="e")
  tkgrid(Env$l.fr3$valeurs.limsup.wdg,row=7,column=4,sticky="w")
  tkgrid(Env$l.fr3$valeurs.log.lab,row=8,column=3,sticky="e")
  tkgrid(Env$l.fr3$valeurs.log.wdg,row=8,column=4,sticky="w")
}
