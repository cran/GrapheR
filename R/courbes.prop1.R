courbes.prop1 <-
function(datas.GrapheR2,var1,var2,niv1,err.type,x.inf,x.sup,y.inf,y.sup,lig,tra,x.legende,y.legende,log.axes,taille.legende,
  col.legende,col.symb,symbol,taille.symb,ep.lig,err.seg) {
